...
import us.jusybiberman.carpetbag.config.GreyList;
...
public abstract class Interaction {
	...
	protected void removeRecipeByOutput(ForgeRegistry<IRecipe> reg, ItemStack outputToRemove, String modid) {
		for (Iterator<IRecipe> iter = reg.iterator(); iter.hasNext(); ) {
			...
			if ((modid == null || modid.equals(Objects.requireNonNull(recipe.getRegistryName()).getNamespace())) && ItemStack.areItemStacksEqual(recipe.getRecipeOutput(), outputToRemove)) {
