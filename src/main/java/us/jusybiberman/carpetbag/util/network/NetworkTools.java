package us.jusybiberman.carpetbag.util.network;
...
public class NetworkTools {
	...
	public static FluidStack readFluidStack(ByteBuf dataIn) {
		...
		try {
			...
			Carpetbag.getLogger().error("Error reading fluid stack", e);
		}
		return null;
	}
	...
	public static void writeFluidStack(ByteBuf dataOut, FluidStack fluidStack) {
		...
		try {
			...
			Carpetbag.getLogger().error("Error writing fluid stack", e);
		}
	}
	...
	public static NBTTagCompound readTag(ByteBuf dataIn) {
		...
		try {
			...
			Carpetbag.getLogger().error("Error reading tag", e);
		}
		return null;
	}
	...
	public static void writeTag(ByteBuf dataOut, NBTTagCompound tag) {
		...
		try {
			...
			Carpetbag.getLogger().error("Error writing tag", e);
		}
	}
	...
	public static ItemStack readItemStack(ByteBuf dataIn) {
		...
		try {
			...
			Carpetbag.getLogger().error("Error reading item stack", e);
		}
	...
	public static void writeItemStack(ByteBuf dataOut, @Nonnull ItemStack itemStack) {
		...
		try {
			...
			Carpetbag.getLogger().error("Error writing item stack", e);
		}
	}
	...
	public static BlockPos readPos(ByteBuf dataIn) {
		if (ModConfiguration.tallChunkFriendly) {
