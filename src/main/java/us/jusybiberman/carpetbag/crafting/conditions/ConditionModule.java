package us.jusybiberman.carpetbag.crafting.conditions;
...
public class ConditionModule implements IConditionFactory {
	...
	public BooleanSupplier parse(JsonContext context, JsonObject json) {
		...
		if(type.equals("carpetbag:module"))
		{
			...
			return () -> invert != (MODULES.containsKey(finalModule) && MODULES.get(finalModule).getAsBoolean());
		}
